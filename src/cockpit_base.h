...
public:
    ...
    virtual void update_controls(uint32_t tick_count, const ReceiverBase& receiver, receiver_context_t& pg) = 0;
    virtual void check_failsafe(uint32_t tick_count, receiver_context_t& pg) = 0;
protected:
